...
def get_semantic_event_testing_dfs(spark: SparkSession):
    ...
    event_df = [
        Row(
            **{
                ...
                ColNames.domain: evdata[5],
                ColNames.cell_id: evdata[6],
                ColNames.latitude: evdata[7],
                ColNames.longitude: evdata[8],
                ColNames.loc_error: evdata[9],
                ColNames.year: 2023,
                ColNames.month: 1,
                ColNames.day: 3,
            }
    ...
    event_df = event_df.withColumn(ColNames.user_id, F.unhex(F.sha2(F.col(ColNames.user_id).cast(StringType()), 256)))
...
def set_input_data(spark: SparkSession, config: ConfigParser):
    ...
    event_data.df.show()  # TODO REMOVE
    event_data.write()
        ...
        [
            Row(
                **{
                    ...
                    ColNames.mnc: "01",
                    ColNames.plmn: None,
                    ColNames.domain: Domains.OUTBOUND,
