...
def test_semantic_cleaning(spark, expected_events, expected_metrics):
    ...
    INPUT:
        ...
        Input Data:
            event_data_silver: /opt/testing_data/..., generated by aux_event_semantic_cleaning.set_input_data
    ...
    assertDataFrameEqual(
        output_metrics_data_object.df.drop(ColNames.result_timestamp),
        expected_metrics.drop(ColNames.result_timestamp),
    )
